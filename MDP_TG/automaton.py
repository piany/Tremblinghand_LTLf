...
class OmegaAutomaton:
    ...
    def __init__(self,ltl,auto_type='ldba'):
        ...
        q0, delta, acc, eps, shape, ap_list = self.ltl2auto(ltl)
        self.q0 = q0
        self.delta = delta
        self.acc = acc
        self.shape = shape
    ...
    def ltl2auto(self,ltl):
        ...
        shape = n_i, n_qs #n_i number of accepting states, n_qs number of states
        ...
        return q0, delta, acc, eps, shape, ap_list
