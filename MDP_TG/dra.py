...
class Product_Dra(DiGraph):
    ...
    def compute_S_f(self):
        ...
        S_f = []
        k = 1
        f_prod_accept = open('to_matlab/data/prod_node_accept.dat','w')
        f_prod_accept_noact = open('to_matlab/data/prod_node_accept_noact.dat','w')
        f_prod_common = open('to_matlab/data/prod_node_common.dat','w')
        f_prod_Ip = open('to_matlab/data/prod_node_Ip.dat','w')
        f_prod_Hp = open('to_matlab/data/prod_node_Hp.dat','w')
        for pair in acc_pairs:
            ...
            for hp in list(Hp):
                f_prod_Hp.write('%s, %s, %s, %s\n' %(hp[0][0], hp[0][1], hp[0][2], hp[2])) 
            # ---find all MECs
